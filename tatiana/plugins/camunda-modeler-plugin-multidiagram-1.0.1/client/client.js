  ...
  getContextPadEntries(element) {
    ...
    eventBus.on('element.dblclick', 1500, function (event) {
      if (isInternalCallActivity(event.element)) {
        // do your stuff here
        openProcess(event, event.element); // stop propagating the event to prevent the default behavior
    ...
    function getDiagram(rootElementId) {
      var diagram = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["find"])(diagramUtil.diagrams(), function (diagram) {
    ...
    function isInternalCallActivity(element) {
      let bo = Object(bpmn_js_lib_util_ModelUtil__WEBPACK_IMPORTED_MODULE_0__["getBusinessObject"])(element);
      return Object(bpmn_js_lib_util_ModelUtil__WEBPACK_IMPORTED_MODULE_0__["is"])(element, 'bpmn:CallActivity') && diagramUtil.diagrams().length > 1 && typeof bo.get('calledElement') !== 'undefined' && bo.get('calledElement').startsWith('inner:');
    }
...
CustomContextPad.$inject = ['config', 'eventBus', 'contextPad', 'injector', 'translate'];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _OpenProcessContextPad__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OpenProcessContextPad */ "./client/bpmn-js-extension/context-pad/OpenProcessContextPad.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  openProcessContextPad: ['type', _OpenProcessContextPad__WEBPACK_IMPORTED_MODULE_0__["default"]]
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DiagramSwitch; });
/* harmony import */ var _cmd_CreateDiagramHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cmd/CreateDiagramHandler */ "./client/bpmn-js-extension/multi-diagram/cmd/CreateDiagramHandler.js");
/* harmony import */ var _cmd_DeleteDiagramHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cmd/DeleteDiagramHandler */ "./client/bpmn-js-extension/multi-diagram/cmd/DeleteDiagramHandler.js");
/* harmony import */ var _cmd_RenameDiagramHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cmd/RenameDiagramHandler */ "./client/bpmn-js-extension/multi-diagram/cmd/RenameDiagramHandler.js");



function DiagramSwitch(eventBus, commandStack, diagramUtil) {
  this._eventBus = eventBus;
  this._commandStack = commandStack;
  this._diagramUtil = diagramUtil; // Bind this globally

  this.registerHandlers = registerHandlers.bind(this); // Register to events

  this._eventBus.on('diagram.init', this.registerHandlers);
}

function registerHandlers() {
  this._commandStack.registerHandler('diagram.create', _cmd_CreateDiagramHandler__WEBPACK_IMPORTED_MODULE_0__["default"]);

  this._commandStack.registerHandler('diagram.delete', _cmd_DeleteDiagramHandler__WEBPACK_IMPORTED_MODULE_1__["default"]);

  this._commandStack.registerHandler('diagram.rename', _cmd_RenameDiagramHandler__WEBPACK_IMPORTED_MODULE_2__["default"]);
}

DiagramSwitch.$inject = ['eventBus', 'commandStack', 'diagramUtil'];
...
DiagramSwitch.prototype.renameDiagram = function (name) {
  if (this._commandStack.canExecute('diagram.rename', {
    newName: name
  })) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CreateDiagramHandler; });
/**
 * Handler which creates a new diagram in the same bpmn file.
 */
function CreateDiagramHandler(bpmnjs, bpmnFactory, diagramUtil, commandStack) {
  this._bpmnjs = bpmnjs;
  this._bpmnFactory = bpmnFactory;
  this._diagramUtil = diagramUtil;
  this._commandStack = commandStack;
}
CreateDiagramHandler.$inject = ['bpmnjs', 'bpmnFactory', 'diagramUtil', 'commandStack'];
...
CreateDiagramHandler.prototype.preExecute = function (context) {
  context.oldDiagramId = this._diagramUtil.currentDiagram().id; // create new semantic objects

  var newProcess = this.createProcess();
  var newDiagram = this.createDiagram(newProcess); // store them in the context
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DeleteDiagramHandler; });
...
function DeleteDiagramHandler(bpmnjs, commandStack, diagramUtil, modeling) {
  this._bpmnjs = bpmnjs;
  this._commandStack = commandStack;
  this._diagramUtil = diagramUtil;
  this._modeling = modeling;
}
DeleteDiagramHandler.$inject = ['bpmnjs', 'commandStack', 'diagramUtil', 'modeling'];
...
DeleteDiagramHandler.prototype.preExecute = function (context) {
  ...
  var diagrams = this._diagramUtil.diagrams(); // switch to the first diagram in the list that is not to be deleted


  var otherDiagramId = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["find"])(diagrams, function (diagram) {
...
DeleteDiagramHandler.prototype.revert = function (context) {
  ...
  this._diagramUtil.definitions().rootElements.splice(context.indices.elementIndex, 0, context.removedProcess);

  this._diagramUtil.diagrams().splice(context.diagramIndex, 0, context.removedDiagram);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RenameDiagramHandler; });
/**
 * Handler which renames the currently displayed diagram.
 */
function RenameDiagramHandler(diagramUtil) {
  this._diagramUtil = diagramUtil;
}
RenameDiagramHandler.$inject = ['diagramUtil'];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DiagramSwitch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DiagramSwitch */ "./client/bpmn-js-extension/multi-diagram/DiagramSwitch.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./client/bpmn-js-extension/multi-diagram/utils/index.js");


/* harmony default export */ __webpack_exports__["default"] = ({
  __init__: ['diagramSwitch'],
  __depends__: [_utils__WEBPACK_IMPORTED_MODULE_1__["default"]],
  diagramSwitch: ['type', _DiagramSwitch__WEBPACK_IMPORTED_MODULE_0__["default"]]
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DiagramUtil; });
/* harmony import */ var min_dash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! min-dash */ "./node_modules/min-dash/dist/index.esm.js");

function DiagramUtil(bpmnjs, canvas) {
  this._bpmnjs = bpmnjs;
  this._canvas = canvas;
}
DiagramUtil.$inject = ['bpmnjs', 'canvas'];
...
DiagramUtil.prototype.currentDiagram = function () {
  ...
  var diagram = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["find"])(this.diagrams(), function (diagram) {
...
DiagramUtil.prototype.removeDiagramById = function (rootElementId) {
  var elementIndex = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["findIndex"])(this.definitions().rootElements, function (rootElement) {
  ...
  var diagramIndex = Object(min_dash__WEBPACK_IMPORTED_MODULE_0__["findIndex"])(this.diagrams(), function (diagram) {
    return diagram.plane.bpmnElement && diagram.plane.bpmnElement.id === rootElementId;
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DiagramUtil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DiagramUtil */ "./client/bpmn-js-extension/multi-diagram/utils/DiagramUtil.js");

/* harmony default export */ __webpack_exports__["default"] = ({
  __init__: ['diagramUtil'],
  diagramUtil: ['type', _DiagramUtil__WEBPACK_IMPORTED_MODULE_0__["default"]]
});
...
/* harmony import */ var _react_DiagramButtons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./react/DiagramButtons */ "./client/react/DiagramButtons.js");
/* harmony import */ var _bpmn_js_extension_multi_diagram__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bpmn-js-extension/multi-diagram */ "./client/bpmn-js-extension/multi-diagram/index.js");
/* harmony import */ var _bpmn_js_extension_context_pad__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bpmn-js-extension/context-pad */ "./client/bpmn-js-extension/context-pad/index.js");
/* harmony import */ var _properties_provider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./properties-provider */ "./client/properties-provider/index.js");





Object(camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__["registerBpmnJSPlugin"])(_bpmn_js_extension_multi_diagram__WEBPACK_IMPORTED_MODULE_2__["default"]);
Object(camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__["registerBpmnJSPlugin"])(_properties_provider__WEBPACK_IMPORTED_MODULE_4__["default"]);
Object(camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__["registerBpmnJSPlugin"])(_bpmn_js_extension_context_pad__WEBPACK_IMPORTED_MODULE_3__["default"]);
Object(camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__["registerClientExtension"])(_react_DiagramButtons__WEBPACK_IMPORTED_MODULE_1__["default"]);

/***/ }),

/***/ "./client/properties-provider/CallActivityExt.js":
/*!*******************************************************!*\
  !*** ./client/properties-provider/CallActivityExt.js ***!
  \*******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CallActivityExt; });
...
/* harmony import */ var bpmn_js_properties_panel_lib_PropertiesActivator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! bpmn-js-properties-panel/lib/PropertiesActivator */ "./node_modules/bpmn-js-properties-panel/lib/PropertiesActivator.js");
/* harmony import */ var bpmn_js_properties_panel_lib_PropertiesActivator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(bpmn_js_properties_panel_lib_PropertiesActivator__WEBPACK_IMPORTED_MODULE_2__);
...
function getCalledElementType(element) {
  ...
  if (typeof boCalledElement !== 'undefined' && boCalledElement.startsWith('inner:')) {
...
function CallActivityExt(eventBus, translate, propertiesProvider, diagramUtil) {
  bpmn_js_properties_panel_lib_PropertiesActivator__WEBPACK_IMPORTED_MODULE_2___default.a.call(this, eventBus);
  ...
  propertiesProvider.getTabs = function (element) {
    ...
    function getRootElement(diagramId) {
      var diagram = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["find"])(diagramUtil.diagrams(), {
        id: diagramId
      });
    ...
    if (Object(bpmn_js_lib_util_ModelUtil__WEBPACK_IMPORTED_MODULE_1__["is"])(element, 'bpmn:CallActivity') && diagrams.length > 1 && getCallableType(element) === 'bpmn') {
      let generalTab = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["find"])(array, {
        id: "general"
      });

      if (generalTab) {
        let detailsGroup = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["find"])(generalTab.groups, {
          id: "details"
        });
        let callActivitySelectIndex = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"])(detailsGroup.entries, {
          id: "callActivity"
        });
        detailsGroup.entries.splice(callActivitySelectIndex + 1, 0, bpmn_js_properties_panel_lib_factory_EntryFactory__WEBPACK_IMPORTED_MODULE_3___default.a.selectBox({
          ...
          set: function (element, values) {
            ...
            return bpmn_js_properties_panel_lib_helper_CmdHelper__WEBPACK_IMPORTED_MODULE_4___default.a.updateProperties(element, props);
          }
        }));
        let callableElementIndex = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"])(detailsGroup.entries, {
          id: "callable-element-ref"
        });

        if (getCalledElementType(element) === 'internal') {
          detailsGroup.entries.splice(callableElementIndex, 1);
          detailsGroup.entries.splice(callableElementIndex, 0, bpmn_js_properties_panel_lib_factory_EntryFactory__WEBPACK_IMPORTED_MODULE_3___default.a.selectBox({
            id: 'callable-inner-element-ref',
            label: translate('Called Element'),
            modelProperty: 'callableElementRef',
            selectOptions: rootElements.filter(rootElement => rootElement.id !== currentRootElement).map(rootElement => {
              return {
                name: rootElement.id,
            ...
            set: function (element, values) {
              ...
              var props = {};
              props['calledElement'] = 'inner:' + newCallableElementRef || false;
              return bpmn_js_properties_panel_lib_helper_CmdHelper__WEBPACK_IMPORTED_MODULE_4___default.a.updateProperties(element, props);
            },
...
inherits__WEBPACK_IMPORTED_MODULE_0___default()(CallActivityExt, bpmn_js_properties_panel_lib_PropertiesActivator__WEBPACK_IMPORTED_MODULE_2___default.a);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CallActivityExt__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CallActivityExt */ "./client/properties-provider/CallActivityExt.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  CallableProcessProvider: ['type', _CallActivityExt__WEBPACK_IMPORTED_MODULE_0__["default"]]
});

/***/ }),

/***/ "./client/react/Button.js":
/*!********************************!*\
  !*** ./client/react/Button.js ***!
  \********************************/
/*! exports provided: default */
...
class Button extends camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  render() {
    const {
      disabled,
      className,
    ...
    return /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", _extends({
...
/***/ "./client/react/DiagramButtons.js":
/*!****************************************!*\
  !*** ./client/react/DiagramButtons.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DiagramButtons; });
/* harmony import */ var camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! camunda-modeler-plugin-helpers/react */ "./node_modules/camunda-modeler-plugin-helpers/react.js");
/* harmony import */ var camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _DropdownButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DropdownButton */ "./client/react/DropdownButton.js");
/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Button */ "./client/react/Button.js");
/* harmony import */ var _modals_rename_diagram_RenameDiagramModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modals/rename-diagram/RenameDiagramModal */ "./client/react/modals/rename-diagram/RenameDiagramModal.js");
...
class DiagramButtons extends camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(props) {
    super(props);

    _defineProperty(this, "getDiagrams", () => {
      const {
        modeler
      } = this.state;
      ...
      if (!!definitions) {
        return definitions.diagrams.map((diagram, index) => {
          ...
          return /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Diagram, {
            id: id,
            key: index,
            onClick: () => {
              bpmnjs.open(id);
    ...
    _defineProperty(this, "addDiagram", () => {
      const {
        modeler
      } = this.state;
    ...
    _defineProperty(this, "deleteDiagram", () => {
      const {
        modeler
      } = this.state;
      ...
      if (definitions && definitions.diagrams.length > 1) {
        this.setState({
          multi: definitions.diagrams.length - 1 > 1
        });
        const commandStack = modeler.get('commandStack');
    ...
    _defineProperty(this, "handleRenameDiagram", newNameObject => {
      const {
        modeler
      } = this.state;
      const commandStack = modeler.get('commandStack');
      commandStack.execute('diagram.rename', {
        newName: newNameObject.activeDiagram
      });
      this.setState({
        renameDiagramModalOpen: false
      });
  ...
  componentDidMount() {
    ...
    */
    ...
    subscribe('bpmn.modeler.created', ({
      ...
      eventBus.on('commandStack.diagram.create.execute', command => this.setState({
        activeDiagram: command.context.newDiagram
      }));
      eventBus.on('commandStack.diagram.delete.execute', () => this.setState({
        activeDiagram: diagramUtil.currentDiagram()
      }));
    });
    subscribe('app.activeTabChanged', tab => {
      ...
      const activeModeler = Object(lodash__WEBPACK_IMPORTED_MODULE_6__["find"])(tabModeler, {
        tabId: activeTabId
      });
  ...
  render() {
    ...
    const initValues = {
      activeDiagram: activeDiagram ? activeDiagram.id : undefined
    ...
    return /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_1__["Fill"], {
      slot: "toolbar",
      group: "9_multidiagram"
    }, /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
      onClick: () => {
        if (this.state.modeler) this.addDiagram();
      },
      disabled: !this.state.modeler,
      title: "New Diagram",
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('toolbarBtn')
    }, /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()("app-icon-multidiagram-new")
    })), /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
      onClick: () => {
        if (this.state.modeler) this.deleteDiagram();
      },
      disabled: !this.state.modeler || !this.state.multi,
      title: "Delete Diagram",
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('toolbarBtn')
    }, /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()("app-icon-multidiagram-delete")
    })), /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
      onClick: () => {
        if (this.state.modeler) this.setState({
          renameDiagramModalOpen: true
        });
      },
      disabled: !this.state.modeler,
      ...
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()("app-icon-multidiagram-rename")
    })), /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_DropdownButton__WEBPACK_IMPORTED_MODULE_2__["default"], {
      title: "Switch diagram",
      disabled: !this.state.modeler,
      items: this.getDiagrams,
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()('dropdownBtn')
    }, /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: classnames__WEBPACK_IMPORTED_MODULE_5___default()("app-icon-new")
    }))), this.state.modeler && this.state.renameDiagramModalOpen && /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_modals_rename_diagram_RenameDiagramModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
class Diagram extends camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    const {
      id,
      onClick,
...
/***/ "./client/react/DropdownButton.js":
/*!****************************************!*\
  !*** ./client/react/DropdownButton.js ***!
  \****************************************/
/*! exports provided: default */
...
class DropdownButton extends camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"] {
  constructor(props, context) {
    super(props, context);

    _defineProperty(this, "onGlobalClick", ({
      target
    }) => {
    ...
    _defineProperty(this, "onDropdownClick", () => {
      const {
        closeOnClick
      } = this.props;
    ...
    this.ref = camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createRef();
  }
  ...
  renderDropdown(items) {
    ...
    if (items && items.length) {
      return /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        className: "dropdown"
      }, items.map((item, index) => {
        return /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          key: index,
          className: "item",
          onClick: () => {
  ...
  render() {
    ...
    return /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", _extends({
      ref: this.ref,
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()({
        disabled,
        active
      }, className)
    }, rest), /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('toolbarBtn', {
        disabled,
        active
      }),
      onClick: this.toggle
    }, text || children, /*#__PURE__*/camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: "caret"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RenameDiagramModal; });
/* harmony import */ var camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! camunda-modeler-plugin-helpers/react */ "./node_modules/camunda-modeler-plugin-helpers/react.js");
/* harmony import */ var camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var camunda_modeler_plugin_helpers_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! camunda-modeler-plugin-helpers/components */ "./node_modules/camunda-modeler-plugin-helpers/components.js");
/* eslint-disable react/prop-types */
...
function RenameDiagramModal({
  initValues,
  onRename,
  onClose
}) {
  const [activeDiagram, setActiveDiagram] = Object(camunda_modeler_plugin_helpers_react__WEBPACK_IMPORTED_MODULE_0__["useState"])(initValues.activeDiagram);

  const onSubmit = () => onRename({
    activeDiagram
  });
